...
vim.cmd([[hi! link @h1_content.markdown GruvboxYellowBold]])
vim.cmd([[hi! link @h1_marker.markdown GruvboxYellowBold]])
vim.cmd([[hi! link @h2_content.markdown GruvboxOrangeBold]])
vim.cmd([[hi! link @h2_marker.markdown GruvboxOrangeBold]])
vim.cmd([[hi! link @h3_content.markdown GruvboxRedBold]])
vim.cmd([[hi! link @h3_marker.markdown GruvboxRedBold]])
vim.cmd([[hi! link @h4_content.markdown GruvboxPurpleBold]])
vim.cmd([[hi! link @h4_marker.markdown GruvboxPurpleBold]])
vim.cmd([[hi! link @h5_content.markdown GruvboxAquaBold]])
vim.cmd([[hi! link @h5_marker.markdown GruvboxAquaBold]])
vim.cmd([[hi! link @h6_content.markdown GruvboxBlueBold]])
vim.cmd([[hi! link @h6_marker.markdown GruvboxBlueBold]])
